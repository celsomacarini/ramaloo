...
<table class="table table-striped table-dark" id="tabela">
  ...
  <tbody>
    ...
    <tr>
      ...
      <th scope="col"><a class="btn btn-outline-primary" href="editar_loja.php?id=<?php echo $item ['id']; ?>" role="button">Editar</a></th>
      <th scope="col"><a class="btn btn-outline-danger" href="excluir_loja.php?id=<?php echo $item ['id']; ?>" role="button">Excluir</a></th>
