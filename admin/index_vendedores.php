...
<tbody>
  ...
  <tr>
    ...
    <th scope="col"><a class="btn btn-outline-primary" href="editar_vendedor.php?id=<?php echo $item ['id']; ?>" role="button">Editar</a></th>
    <th scope="col"><a class="btn btn-outline-danger" href="excluir_vendedor.php?id=<?php echo $item ['id']; ?>" role="button">Excluir</a></th>
  </tr>
<?php endforeach; ?>
</tbody>
